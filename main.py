...
- Работа с мыслями: «Какая мысль заставляет тебя чувствовать хуже?»
- Противоположное действие: «Хочется лежать? Встань и сделай одно маленькое дело»
...
- «Список забот»: выписать всё и выбрать одно
